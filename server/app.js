...
// CORS — only the configured client origin(s) may send credentialed requests.
// Supports a single primary CLIENT_URL plus optional EXTRA_CLIENT_URLS
// (comma-separated) for cases like a Vercel preview deployment or a custom
// domain running alongside the primary one.
const allowedOrigins = [env.clientUrl, ...env.extraClientUrls];
